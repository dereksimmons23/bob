export const CATEGORY_LIBRARY = {
  ...
  nye: {
    ...
    categories: [
      ...
      { name: "Best Month of the Year", featured: true, entrants: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"] },
      { name: "Best Movie This Year", entrants: ["(Add your nominees!)", "Best Picture Contender 1", "Best Picture Contender 2", "Biggest Blockbuster", "Best Comedy", "Best Drama", "Best Action", "Best Animated"] },
      { name: "Best Song This Year", entrants: ["(Add your nominees!)", "Top Billboard Hit", "Viral TikTok Song", "Best Album Track", "Best Collab", "Song of the Summer", "Best Comeback", "Best New Artist"] },
