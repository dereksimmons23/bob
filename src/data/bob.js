...
export const BOB = {
  ...
  categoryOpeners: {
    ...
    marchmadness: [
      "It's tournament time. Seeds don't matter. Heart does.",
      "One shining moment. Sixty-eight teams. One bracket. Vote.",
      "Chalk or chaos? You decide.",
      "The dance starts now. Every matchup matters.",
      "Cinderellas and blue bloods. Pick your side.",
      "March is for madness. Let's get loud.",
      "Selection Sunday was just the beginning.",
      "Busted brackets and broken hearts. Welcome to March.",
      "The Big Dance. Where legends are made and brackets die.",
      "Tournament time. No mercy. No mulligans.",
    ],
    custom: [
  ...
  matchupCommentary: {
    ...
    marchmadness: [
      "This is a tournament matchup. No second chances.",
      "Win or go home. Pick one.",
      "The selection committee is watching. Vote wisely.",
      "Upsets happen in March. Make one.",
      "Seed rankings are suggestions. Your vote is final.",
      "This matchup could bust a million brackets.",
      "Who survives and advances?",
      "Every March has a moment. Is this it?",
      "Blue blood or underdog. Which side are you on?",
      "The madness is in the choosing.",
    ],
    olympics: [
    ...
    nye: [
      ...
      "The old year is watching. The new year is waiting.",
      ...
      "One will welcome the new year as champion.",
  ...
  championNYE: [
    "And so we welcome the new year with a champion.",
    "The last champion of the year. Or the first of the next. Either way: legendary.",
    "Champagne worthy. Champion crowned.",
    "Ring in the new year with a winner.",
    "Last year's final verdict. This year's first champion.",
    "The ball has dropped. The champion has risen.",
    "New year. New champion. Same voters.",
    "Midnight approaches. Champion decided.",
    "Start the year right. With a champion.",
